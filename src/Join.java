...
public class Join {
  ...
  public Relation getRelation(String name) {
    ...
    if ( noJoinCondition || validateAttributes()) {
      ...
      System.out.println("Error validating attributes on: " + joinConditions[0] + ". Attributes must have compatible types.");
      return null;
    }
  }
  ...
  // Returns an attribute from a qualified or non qualified string, ie "COURSE.CNUM" or just "CNUM".
